...
export default defineConfig({
  ...
  shortcuts: [{
    ...
    // Below-positioned tooltip variant with the same visual style as gpt-copy-tips
    'gpt-copy-tips-below': 'op-0 h-7 bg-black px-2.5 py-1 box-border text-xs c-white fcc rounded absolute z-20 transition duration-600 whitespace-nowrap top-full mt-1 left-50% -translate-x-50%',
